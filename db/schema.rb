...
ActiveRecord::Schema.define(version: 2019_03_27_052704) do
  ...
  create_table "docs", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_docs_on_email", unique: true
    t.index ["reset_password_token"], name: "index_docs_on_reset_password_token", unique: true
  end
  ...
  create_table "doctor_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_doctor_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_doctor_users_on_reset_password_token", unique: true
  end
